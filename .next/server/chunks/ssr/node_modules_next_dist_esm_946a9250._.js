...
function getRenderedPathname(response) {
    ...
    return rewrittenPath != null ? rewrittenPath : new URL(response.url).pathname;
}
...
function getCacheKeyForDynamicParam(paramValue) {
    // This needs to match the logic in get-dynamic-param.ts, until we're able to
    // unify the various implementations so that these are always computed on
    // the client.
    return typeof paramValue === 'string' ? paramValue : paramValue === null ? '' : paramValue.join('/');
...
;
;
function getFlightDataPartsFromPath(flightDataPath, renderedPathname) {
...
function normalizeFlightData(flightData, renderedPathname) {
    // FlightData can be a string when the server didn't respond with a proper flight response,
    // or when a redirect happens, to signal to the client that it needs to perform an MPA navigation.
    if (typeof flightData === 'string') {
        return flightData;
    }
    return flightData.map((flightDataPath)=>getFlightDataPartsFromPath(flightDataPath, renderedPathname));
}
...
function fillTreeWithParamValues(renderedPathname, segmentPath, flightRouterState) {
    ...
    for(let i = 0; i < segmentPath.length; i += 2){
        ...
        if (Array.isArray(segment) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$route$2d$params$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doesStaticSegmentAppearInURL"])(segment)) {
            // This segment appears in the URL, so we need to skip over this part
            // of the pathname
            pathnamePartsIndex++;
        }
    }
    fillTreeWithParamValuesImpl(renderedPathname, flightRouterState, pathnameParts, pathnamePartsIndex);
}
function fillTreeWithParamValuesImpl(renderedPathname, flightRouterState, pathnameParts, pathnamePartsIndex) {
    ...
    // segment[1] = segmentCacheKey
        ...
        doesAppearInURL = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$route$2d$params$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doesStaticSegmentAppearInURL"])(segment);
    }
    ...
    for(const parallelRouteKey in parallelRoutes){
        fillTreeWithParamValuesImpl(renderedPathname, parallelRoutes[parallelRouteKey], pathnameParts, childPathnamePartsIndex);
    }
   ...
   */ if (prefetchKind === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$router$2d$reducer$2f$router$2d$reducer$2d$types$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PrefetchKind"].AUTO) {
    ...
    try {
        ...
        ;
            ...
            renderedPathname = new URL(renderedUrlParts.join('/'), 'http://localhost').pathname;
        }
        return {
            flightData: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$flight$2d$data$2d$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeFlightData"])(response.f, renderedPathname),
...
//# sourceMappingURL=node_modules_next_dist_esm_946a9250._.js.map
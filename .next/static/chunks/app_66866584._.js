        ...
        "BlogPost.useEffect": ()=>{
            if (params === null || params === void 0 ? void 0 : params.slug) {
                ...
                const foundPost = blogPosts.find({
                    "BlogPost.useEffect.foundPost": (post)=>post.slug === slug
                }["BlogPost.useEffect.foundPost"]);
                if (foundPost) {
                    setPost(foundPost);
                    setRelatedPosts(blogPosts.filter({
                        "BlogPost.useEffect": (p)=>p.slug !== slug
                    }["BlogPost.useEffect"]).slice(0, 3));
                }
                setLoading(false);
            }
        }
...
_s(BlogPost, "30BmAVmovC+aMhNTdJcLgnELAnI=", false, function() {
    return [
...
//# sourceMappingURL=app_66866584._.js.map
...
const version = "15.4.2-canary.31";
window.next = {
    version,
    appDir: true
};
...
function fillTreeWithParamValues(renderedPathname, segmentPath, flightRouterState) {
    ...
    for(let i = 0; i < segmentPath.length; i += 2){
        ...
        if (Array.isArray(segment) || (0, _routeparams.doesStaticSegmentAppearInURL)(segment)) {
...
function fillTreeWithParamValuesImpl(renderedPathname, flightRouterState, pathnameParts, pathnamePartsIndex) {
    ...
    // segment[1] = segmentCacheKey
        ...
        doesAppearInURL = (0, _routeparams.doesStaticSegmentAppearInURL)(segment);
    }
...
async function fetchServerResponse(url, options) {
   ...
   */ if (prefetchKind === _routerreducertypes.PrefetchKind.AUTO) {
    ...
    try {
        ...
        return {
            flightData: (0, _flightdatahelpers.normalizeFlightData)(response.f, renderedPathname),
...
async function fetchServerAction(state, nextUrl, param) {
    ...
    if (isRscResponse) {
        ...
        ;
            ...
            renderedPathname = new URL(canonicalUrlParts.join('/'), 'http://localhost').pathname;
        }
        // An internal redirect can send an RSC response, but does not have a useful `actionResult`.
        actionResult = redirectLocation ? undefined : response.a;
        actionFlightData = (0, _flightdatahelpers.normalizeFlightData)(response.f, renderedPathname);
    } else {
...
function createInitialRouterState(param) {
    ...
    // that response.
    const renderedPathname = new URL(initialCanonicalUrl, 'http://localhost').pathname;
    const normalizedFlightData = (0, _flightdatahelpers.getFlightDataPartsFromPath)(initialFlightData[0], renderedPathname);
...
//# sourceMappingURL=node_modules_next_dist_client_0f0523c0._.js.map
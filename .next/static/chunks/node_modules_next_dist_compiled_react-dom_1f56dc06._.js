...
"production" !== ("TURBOPACK compile-time value", "development") && function() {
    ...
    function updateSuspenseComponent(current, workInProgress, renderLanes) {
        ...
        (JSCompiler_object_inline_digest_2552 = didSuspend) || (JSCompiler_object_inline_digest_2552 = null !== current && null === current.memoizedState ? !1 : 0 !== (suspenseStackCursor.current & ForceSuspenseFallback));
        JSCompiler_object_inline_digest_2552 && (JSCompiler_object_inline_message_2551 = !0, workInProgress.flags &= -129);
        JSCompiler_object_inline_digest_2552 = 0 !== (workInProgress.flags & 32);
        workInProgress.flags &= -33;
        if (null === current) {
            if (isHydrating) {
                JSCompiler_object_inline_message_2551 ? pushPrimaryTreeSuspenseHandler(workInProgress) : reuseSuspenseHandlerOnStack(workInProgress);
                (current = nextHydratableInstance) ? (renderLanes = canHydrateHydrationBoundary(current, rootOrSingletonContext), renderLanes = null !== renderLanes && renderLanes.data !== ACTIVITY_START_DATA ? renderLanes : null, null !== renderLanes && (JSCompiler_object_inline_digest_2552 = {
                    dehydrated: renderLanes,
                    treeContext: getSuspendedTreeContext(),
                    retryLane: 536870912,
                    hydrationErrors: null
                }, workInProgress.memoizedState = JSCompiler_object_inline_digest_2552, JSCompiler_object_inline_digest_2552 = createFiberFromDehydratedFragment(renderLanes), JSCompiler_object_inline_digest_2552.return = workInProgress, workInProgress.child = JSCompiler_object_inline_digest_2552, hydrationParentFiber = workInProgress, nextHydratableInstance = null)) : renderLanes = null;
            ...
            JSCompiler_object_inline_stack_2553 = JSCompiler_object_inline_stack_2553.fallback;
            if (JSCompiler_object_inline_message_2551) {
                ...
                JSCompiler_object_inline_stack_2553 = createFiberFromFragment(JSCompiler_object_inline_stack_2553, mode, renderLanes, null);
                ...
                nextPrimaryChildren.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2552, renderLanes);
        ...
        if (null !== prevState) {
            ...
            if (null !== JSCompiler_object_inline_componentStack_2554) {
                if (didSuspend) workInProgress.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress), workInProgress.flags &= -257, workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes)) : null !== workInProgress.memoizedState ? (reuseSuspenseHandlerOnStack(workInProgress), workInProgress.child = current.child, workInProgress.flags |= 128, workInProgress = null) : (reuseSuspenseHandlerOnStack(workInProgress), nextPrimaryChildren = JSCompiler_object_inline_stack_2553.fallback, mode = workInProgress.mode, JSCompiler_object_inline_stack_2553 = mountWorkInProgressOffscreenFiber({
                    mode: "visible",
                    children: JSCompiler_object_inline_stack_2553.children
                }, mode), nextPrimaryChildren = createFiberFromFragment(nextPrimaryChildren, mode, renderLanes, null), nextPrimaryChildren.flags |= 2, JSCompiler_object_inline_stack_2553.return = workInProgress, nextPrimaryChildren.return = workInProgress, JSCompiler_object_inline_stack_2553.sibling = nextPrimaryChildren, workInProgress.child = JSCompiler_object_inline_stack_2553, reconcileChildFibers(workInProgress, current.child, null, renderLanes), JSCompiler_object_inline_stack_2553 = workInProgress.child, JSCompiler_object_inline_stack_2553.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_stack_2553.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2552, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, workInProgress = nextPrimaryChildren);
                else if (pushPrimaryTreeSuspenseHandler(workInProgress), warnIfHydrating(), isSuspenseInstanceFallback(JSCompiler_object_inline_componentStack_2554)) {
                    JSCompiler_object_inline_digest_2552 = JSCompiler_object_inline_componentStack_2554.nextSibling && JSCompiler_object_inline_componentStack_2554.nextSibling.dataset;
                    ...
                    nextPrimaryChildren.stack = JSCompiler_object_inline_stack_2553 || "";
                    nextPrimaryChildren.digest = JSCompiler_object_inline_digest_2552;
                    JSCompiler_object_inline_digest_2552 = void 0 === mode ? null : mode;
                    JSCompiler_object_inline_stack_2553 = {
                        value: nextPrimaryChildren,
                        source: null,
                        stack: JSCompiler_object_inline_digest_2552
                    };
                    "string" === typeof JSCompiler_object_inline_digest_2552 && CapturedStacks.set(nextPrimaryChildren, JSCompiler_object_inline_stack_2553);
                    queueHydrationError(JSCompiler_object_inline_stack_2553);
                    workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
                } else if (didReceiveUpdate || propagateParentContextChanges(current, workInProgress, renderLanes, !1), JSCompiler_object_inline_digest_2552 = 0 !== (renderLanes & current.childLanes), didReceiveUpdate || JSCompiler_object_inline_digest_2552) {
                    JSCompiler_object_inline_digest_2552 = workInProgressRoot;
                    if (null !== JSCompiler_object_inline_digest_2552 && (JSCompiler_object_inline_stack_2553 = getBumpedLaneForHydration(JSCompiler_object_inline_digest_2552, renderLanes), 0 !== JSCompiler_object_inline_stack_2553 && JSCompiler_object_inline_stack_2553 !== prevState.retryLane)) throw prevState.retryLane = JSCompiler_object_inline_stack_2553, enqueueConcurrentRenderForLane(current, JSCompiler_object_inline_stack_2553), scheduleUpdateOnFiber(JSCompiler_object_inline_digest_2552, current, JSCompiler_object_inline_stack_2553), SelectiveHydrationException;
                    isSuspenseInstancePending(JSCompiler_object_inline_componentStack_2554) || renderDidSuspendDelayIfPossible();
                    workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
                } else isSuspenseInstancePending(JSCompiler_object_inline_componentStack_2554) ? (workInProgress.flags |= 192, workInProgress.child = current.child, workInProgress = null) : (current = prevState.treeContext, nextHydratableInstance = getNextHydratable(JSCompiler_object_inline_componentStack_2554.nextSibling), hydrationParentFiber = workInProgress, isHydrating = !0, hydrationErrors = null, didSuspendOrErrorDEV = !1, hydrationDiffRootDEV = null, rootOrSingletonContext = !1, null !== current && restoreSuspendedTreeContext(workInProgress, current), workInProgress = mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_stack_2553.children), workInProgress.flags |= 4096);
                return workInProgress;
            }
        }
        if (JSCompiler_object_inline_message_2551) return reuseSuspenseHandlerOnStack(workInProgress), nextPrimaryChildren = JSCompiler_object_inline_stack_2553.fallback, mode = workInProgress.mode, componentStack = current.child, JSCompiler_object_inline_componentStack_2554 = componentStack.sibling, JSCompiler_object_inline_stack_2553 = createWorkInProgress(componentStack, {
            mode: "hidden",
            children: JSCompiler_object_inline_stack_2553.children
        }), JSCompiler_object_inline_stack_2553.subtreeFlags = componentStack.subtreeFlags & 65011712, null !== JSCompiler_object_inline_componentStack_2554 ? nextPrimaryChildren = createWorkInProgress(JSCompiler_object_inline_componentStack_2554, nextPrimaryChildren) : (nextPrimaryChildren = createFiberFromFragment(nextPrimaryChildren, mode, renderLanes, null), nextPrimaryChildren.flags |= 2), nextPrimaryChildren.return = workInProgress, JSCompiler_object_inline_stack_2553.return = workInProgress, JSCompiler_object_inline_stack_2553.sibling = nextPrimaryChildren, workInProgress.child = JSCompiler_object_inline_stack_2553, JSCompiler_object_inline_stack_2553 = nextPrimaryChildren, nextPrimaryChildren = workInProgress.child, mode = current.child.memoizedState, null === mode ? mode = mountSuspenseOffscreenState(renderLanes) : (componentStack = mode.cachePool, null !== componentStack ? (JSCompiler_object_inline_componentStack_2554 = CacheContext._currentValue, componentStack = componentStack.parent !== JSCompiler_object_inline_componentStack_2554 ? {
        ...
        }), nextPrimaryChildren.memoizedState = mode, nextPrimaryChildren.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2552, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2553;
        pushPrimaryTreeSuspenseHandler(workInProgress);
        ...
        null !== current && (JSCompiler_object_inline_digest_2552 = workInProgress.deletions, null === JSCompiler_object_inline_digest_2552 ? (workInProgress.deletions = [
            current
        ], workInProgress.flags |= 16) : JSCompiler_object_inline_digest_2552.push(current));
    ...
    (function() {
        ...
        if ("19.2.0-canary-be11cb5c-20250804" !== isomorphicReactPackageVersion) throw Error('Incompatible React versions: The "react" and "react-dom" packages must have the exact same version. Instead got:\n  - react:      ' + (isomorphicReactPackageVersion + "\n  - react-dom:  19.2.0-canary-be11cb5c-20250804\nLearn more: https://react.dev/warnings/version-mismatch"));
    })();
